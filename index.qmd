...
Numeric (now called NumPy) was [announced in 1995](http://hugunin.net/papers/hugunin95numpy.html). matplotlib has **not** been created, [it first release was in 2003](https://matplotlib.org/stable/project/license.html#copyright-policy).
...
ggplot (now called ggplot2) has **not** been created, [it first release was in 2006](https://cran.r-project.org/src/contrib/Archive/ggplot/).
:::
...
IPython Notebook (now called Jupyter Notebook) was [released in 2011](https://ipython.org/news.html#ipython-0-12).
